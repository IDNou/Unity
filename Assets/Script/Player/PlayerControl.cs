...
public class PlayerControl : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (!GameManager.Instance.isPlayerDie)
        {
            ...
            {
                if (btnMeteo.GetComponentInChildren<FillMode>().AbleSkil())
                {
                ...
                {
                    if (!SoundManager.Instance.EFXPlayingSound("Error"))
                        SoundManager.Instance.EFXPlaySound("Error");
                }
            }
            ...
            {
                if (btnRainOfFire.GetComponentInChildren<FillMode>().AbleSkil())
                {
                    if (this.GetComponent<Status>().MP >= 80)
                    {
                        isAttack = false;
            ...
            {
                if (btnPowerMeteo.GetComponentInChildren<FillMode>().AbleSkil())
                {
